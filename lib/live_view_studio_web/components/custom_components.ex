defmodule LiveViewStudioWeb.CustomComponents do
  # exported by default in live_view_studio_web.ex line 88
  ...
  def badge(assigns) do
    ~H"""
      <span
      class={["inline-flex items-center gap-0.5 rounded-full bg-gray-300 px-3 py-0.5 text-sm font-medium text-gray-800 hover:cursor-pointer", @class]}
      {@rest}
      >
        <%= @label %>
